...
import WorkedExampleStudyPage from "@/pages/worked-example-study";
...
function Router() {
  return (
    <PageErrorBoundary label="route">
      ...
      <Route path="/examples/:slug" component={WorkedExampleStudyPage} />
      <Route path="/es/ejemplos/:slug" component={WorkedExampleStudyPage} />
