/**
 * Every translated string in the app, in both languages.
 *
 * WHY THIS IS ITS OWN FILE
 *
 * It used to live inside i18n.ts, alongside the i18next `init` call. Importing
 * it therefore meant booting i18next and its browser language detector, which
 * a test running in Node cannot do - so nothing could check these tables, and
 * a whole missing namespace went unnoticed in production.
 *
 * THE FAILURE THAT IS EASY TO MISS
 *
 * Components call `t("auth.email", "Email")`. When the key does not exist,
 * i18next quietly returns the second argument. English therefore looks
 * perfect, and Spanish shows English - so the bug is invisible to anyone
 * testing in English, which is everyone by default.
 *
 * That is exactly what happened: the entire `auth` namespace was missing, and
 * a Spanish student got a sign-up form reading "Create Account / First Name /
 * Confirm Password" inside an otherwise fully translated page.
 *
 * server/__tests__/i18nCoverage.test.ts now reads this file and every t() call
 * in the client, and fails when a key is missing from either language.
 */
  ...
  en: {
    translation: {
      ...
      auth: {
        ...
        signupSubtitle: "Join Easy Pass and start preparing for your Texas licensing exams",
        ...
        signUp: "Sign up",
        signIn: "Sign in",
        caseSensitiveNote: "Login and passwords are case sensitive. Please write down your password in a safe place.",
      ...
      exam: {
        ...
        submit: "Submit Exam",
        endQuiz: "End Quiz",
        submitFailed: "We couldn't record your results. Please try submitting again.",
        cancel: "Cancel",
      ...
      study: {
        subscribe: "Subscribe",
        subscriptionRequiredShort: "Subscription required",
        subscriptionRequiredForQuiz: "Subscription required to take this Quiz",
        subscriptionRequiredForQuizDesc: "You need an active subscription for this exam category to take this quiz.",
        title: "Study Guide",
  ...
  es: {
    translation: {
      ...
      auth: {
        ...
        loginSubtitle: "Inicia sesión para continuar tu preparación",
        signupTitle: "Crear Cuenta",
        signupSubtitle: "Únete a Easy Pass y comienza a prepararte para tus exámenes de licencia de Texas",
        firstName: "Nombre",
        lastName: "Apellido",
        ...
        caseSensitiveNote: "El correo y la contraseña distinguen entre mayúsculas y minúsculas. Anota tu contraseña en un lugar seguro.",
      ...
      exam: {
        ...
        submitFailed: "No pudimos registrar tus resultados. Inténtalo de nuevo.",
        cancel: "Cancelar",
      ...
      study: {
        ...
        subscriptionRequiredShort: "Se requiere suscripción",
        subscriptionRequiredForQuiz: "Se requiere una suscripción para hacer este cuestionario",
        subscriptionRequiredForQuizDesc: "Necesitas una suscripción activa para esta categoría de examen para hacer este cuestionario.",
