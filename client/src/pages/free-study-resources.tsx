...
const RESOURCES = [
  {
    title: "Free Real Estate Practice Test",
    description: "Try Texas real estate practice questions and see where you need more study before moving into full exam prep.",
    href: "/free/texas-real-estate-practice-test",
    type: "Practice Test",
  },
  {
    title: "Free P&C Practice Test",
    description: "Practice Texas Property & Casualty insurance concepts with the MyEasyPass guest practice experience.",
    href: "/free/texas-property-casualty-practice-test",
    type: "Practice Test",
  },
  {
    title: "Free Life Insurance Practice Test",
    description: "Practice Texas life insurance licensing concepts before deciding whether you need the full study system.",
    href: "/free/texas-life-insurance-practice-test",
    type: "Practice Test",
  },
  {
    title: "Free General Lines Practice Test",
    description: "Try Texas General Lines Life, Accident, Health and HMO practice questions with instant study feedback.",
    href: "/free/texas-general-lines-practice-test",
    type: "Practice Test",
  },
  {
    title: "Insurance Exam Concepts",
    description: "Study Property & Casualty concepts such as deductible, indemnity, subrogation, coinsurance and other high-value exam topics.",
    href: "/texas-insurance-exam/concepts",
    type: "Study Guide",
  },
  {
    title: "Life & Health Concepts",
    description: "Review life and health concepts including beneficiaries, premiums, insurable interest, annuities and policy comparisons.",
    href: "/texas-life-health-exam/concepts",
    type: "Study Guide",
  },
  {
    title: "Real Estate Concepts",
    description: "Build confidence on agency, property, fixtures, market value and other Texas real estate exam concepts.",
    href: "/texas-real-estate-exam/concepts",
    type: "Study Guide",
  },
] as const;
        ...
        <section className="bg-gradient-to-b from-primary/5 to-background py-16 md:py-20">
          <div className="container mx-auto max-w-5xl px-4 text-center">
            ...
            <p className="mx-auto mt-5 max-w-3xl text-lg leading-relaxed text-muted-foreground">
              Start with free practice tests and plain-English study guides for Texas real estate and insurance licensing exams. Learn the concepts, test yourself, and move into full exam prep only when you need it.
            </p>
          </div>
        </section>
