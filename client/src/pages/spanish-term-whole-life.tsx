    ...
    jsonLd: [
      {
        ...
        "@type": "Article",
        headline: "Seguro a término vs vida entera: ¿cuál es la diferencia?",
        description: "Comparación educativa entre seguro de vida a término y vida entera para preparación de examen.",
        url: canonical,
        inLanguage: "es",
        publisher: { "@type": "Organization", name: "MyEasyPass" },
      },
      {
        "@context": "https://schema.org",
        "@type": "BreadcrumbList",
      ...
      <main className="flex-1">
        ...
        <section className="py-12 md:py-16">
          <div className="container mx-auto px-4 max-w-5xl grid gap-6 md:grid-cols-2">
            <Card>
              <CardHeader><CardTitle>Seguro a término</CardTitle></CardHeader>
              <CardContent><ul className="space-y-3 text-muted-foreground"><li>• Cobertura diseñada para un período específico.</li><li>• Normalmente se enfoca en la protección por fallecimiento.</li><li>• La estructura de prima y renovación depende del contrato.</li></ul></CardContent>
            </Card>
            <Card>
              <CardHeader><CardTitle>Vida entera</CardTitle></CardHeader>
              <CardContent><ul className="space-y-3 text-muted-foreground"><li>• Forma de seguro de vida permanente.</li><li>• Normalmente incluye características de valor en efectivo.</li><li>• Las garantías y primas dependen del contrato.</li></ul></CardContent>
            </Card>
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 bg-muted/30">
          <div className="container mx-auto px-4 max-w-4xl">
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              <Button asChild><Link href="/es/free/prueba-practica-seguro-vida-texas">Práctica gratis</Link></Button>
              <Button variant="outline" asChild><Link href="/es/preparacion-examen-seguros-vida-texas">Preparación completa</Link></Button>
              <Button variant="outline" asChild><Link href="/es/conceptos-seguros-texas">Más conceptos</Link></Button>
            </div>
